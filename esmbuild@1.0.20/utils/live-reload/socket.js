...
var require_socket = __commonJS({
  "node_modules/engine.io-client/lib/socket.js"(exports, module) {
    ...
    var parseuri = require_parseuri();
    var parseqs = require_parseqs();
    var Socket3 = class extends Emitter {
      constructor(uri, opts = {}) {
        super();
        ...
        const onTransportOpen = () => {
          ...
          transport.once("packet", (msg) => {
            ...
            if (msg.type === "pong" && msg.data === "probe") {
              ...
              if (!transport)
                return;
              Socket3.priorWebsocketSuccess = transport.name === "websocket";
      ...
      onOpen() {
        debug("socket open");
        this.readyState = "open";
        Socket3.priorWebsocketSuccess = this.transport.name === "websocket";
        this.emit("open");
        this.flush();
    ...
    Socket3.priorWebsocketSuccess = false;
    Socket3.protocol = parser.protocol;
    function clone(obj) {
      const o = {};
      for (let i in obj) {
        if (obj.hasOwnProperty(i)) {
...
var require_lib2 = __commonJS({
  "node_modules/engine.io-client/lib/index.js"(exports, module) {
    ...
    module.exports = (uri, opts) => new Socket3(uri, opts);
    module.exports.Socket = Socket3;
    module.exports.protocol = Socket3.protocol;
...
var socket_default = {
  connect(endpoint) {
    return new Promise((resolve, reject) => {
      const socket = (0, import_build.default)(endpoint);
      socket.on("connect", () => {
