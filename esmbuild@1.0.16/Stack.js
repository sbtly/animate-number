...
var stack = import_emotion_css_cjs.css`
  position: absolute;
  left: 0;
  /* background: salmon; */
...
`;
var stackContainer = import_emotion_css_cjs.css`
  display: flex;
  gap: 0px;
...
function Stack(props) {
  ...
  useEffect(() => {
    const arr2 = returnStackItemsLoop(props.startNum, props.endNum, props.loopCount, props.toIsLargerThenFrom);
    setArr(arr2);
  ...
  useLayoutEffect(() => {
    let ctx = gsap.context(() => {
      ...
      rollMotion.current = props.mode === "quickNormal" || props.mode === "quickBounce" ? gsap.fromTo(wrapperRef.current, {
        yPercent: props.toIsLargerThenFrom ? 0 : -(100 - 100 / 2)
      }, __spreadValues({
        yPercent: props.toIsLargerThenFrom ? -(100 - 100 / 2) : 0
      }, props.stackEasing)) : gsap.fromTo(wrapperRef.current, {
        yPercent: props.toIsLargerThenFrom ? 0 : -(100 - 100 / (arr == null ? void 0 : arr.length))
      }, __spreadValues({
        yPercent: props.toIsLargerThenFrom ? -(100 - 100 / (arr == null ? void 0 : arr.length)) : 0
      }, props.stackEasing));
      (_a = tl.current) == null ? void 0 : _a.add(rollMotion.current);
    });
    return () => {
      ctx.revert();
    };
  ...
  useEffect(() => {
    var _a;
    (_a = tl.current) == null ? void 0 : _a.pause(0);
  }, [props.reset]);
  useEffect(() => {
    var _a;
    (_a = tl.current) == null ? void 0 : _a.restart(true, false);
  }, [props.play]);
